 ...
 * @since 0.1.0
 * @deprecated As of release 1.0.0-rc1, replaced by {@link com.dzaitsev.rxviper.Interactor}
 */
@Deprecated
public abstract class Interactor<Param, Result> implements Subscription {
   ...
   * @since 0.4.0
   */
  public final void execute(Action1<? super Result> onNext, Action1<Throwable> onError, Action0 onCompleted, Param param) {
    Preconditions.checkNotNull(onNext, "onNext");
    Preconditions.checkNotNull(onError, "onError");
